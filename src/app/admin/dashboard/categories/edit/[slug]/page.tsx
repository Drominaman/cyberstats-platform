...
export default function EditCategoryPage({ params }: { params: { slug: string } }) {
  ...
  const existingOverride = categoryOverrides.find((c: any) => c.slug === params.slug)
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Add a custom description for this category..."
                />
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-medium transition-colors flex items-center justify-center space-x-2"
              >
              ...
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 px-3 py-1.5 bg-purple-600 text-white rounded text-xs hover:bg-purple-700 transition-colors flex items-center space-x-1"
                  >
                    {copied ? (
                      <>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <ol className="text-sm text-blue-800 space-y-1 list-decimal list-inside">
                    ...
                    <li>Open <code className="bg-blue-100 px-1 py-0.5 rounded">/src/data/category-overrides.json</code></li>
                    <li>Find the category with slug "{params.slug}" and update it, or add this as a new entry</li>
